...
def main():
    ...
    logger.info("╔════════════════════════════════════════════════════════════════════════════════════════════════════════════╗ ")
    logger.info("║                                 Welocome to TuGraph-DB ChatBot!                                            ║")
    logger.info("║ -----------------------------------------------------------------------------------------------------------║")
    logger.info("║  ████████    ██████                    ██       ████   ████   █████ ██                  ████               ║")
    logger.info("║     ██       ██                        ██       ██  █  █  █   ██    ██             ██   █  █         ██    ║")
    logger.info("║     ██  █  █ ██  ██  ███  █████ ██████ █████    ██   █ █████  ██    █████  █████ ██████ █████ ████ ██████  ║")
    ...
    logger.info("║                                 ██                                                                         ║")
    logger.info("║ -----------------------------------------------------------------------------------------------------------║")
    logger.info("║  Hello! I'm ChatBot of Tugraph-DB. I'm so glad to help you ~                                               ║")
    logger.info("║  You can give me a question or an instruction to describe how you want to interact with Tugraph-DB,        ║")
    logger.info("║  and I'll give you the corresponding cypher!                                                               ║")
    logger.info("╚════════════════════════════════════════════════════════════════════════════════════════════════════════════╝")
