...
class GQLVisitor(ParseTreeVisitor):
    ...
    def visitSessionSetGraphParameterClause(self, ctx:GQLParser.SessionSetGraphParameterClauseContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#sessionSetBindingTableParameterClause.
    def visitSessionSetBindingTableParameterClause(self, ctx:GQLParser.SessionSetBindingTableParameterClauseContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#sessionSetValueParameterClause.
    def visitSessionSetValueParameterClause(self, ctx:GQLParser.SessionSetValueParameterClauseContext):
        return self.visitChildren(ctx)
    ...
    def visitSessionParameterSpecification(self, ctx:GQLParser.SessionParameterSpecificationContext):
        return self.visitChildren(ctx)
    ...
    def visitNestedDataModifyingProcedureSpecification(self, ctx:GQLParser.NestedDataModifyingProcedureSpecificationContext):
        return self.visitChildren(ctx)
    ...
    def visitBindingVariableDefinitionBlock(self, ctx:GQLParser.BindingVariableDefinitionBlockContext):
        return self.visitChildren(ctx)
    ...
    def visitBindingTableVariableDefinition(self, ctx:GQLParser.BindingTableVariableDefinitionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#optTypedBindingTableInitializer.
    def visitOptTypedBindingTableInitializer(self, ctx:GQLParser.OptTypedBindingTableInitializerContext):
        return self.visitChildren(ctx)
    ...
    def visitNestedBindingTableQuerySpecification(self, ctx:GQLParser.NestedBindingTableQuerySpecificationContext):
        return self.visitChildren(ctx)
    ...
    def visitLinearCatalogModifyingStatement(self, ctx:GQLParser.LinearCatalogModifyingStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#simpleCatalogModifyingStatement.
    def visitSimpleCatalogModifyingStatement(self, ctx:GQLParser.SimpleCatalogModifyingStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#primitiveCatalogModifyingStatement.
    def visitPrimitiveCatalogModifyingStatement(self, ctx:GQLParser.PrimitiveCatalogModifyingStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitCallCatalogModifyingProcedureStatement(self, ctx:GQLParser.CallCatalogModifyingProcedureStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitFocusedLinearDataModifyingStatement(self, ctx:GQLParser.FocusedLinearDataModifyingStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#focusedLinearDataModifyingStatementBody.
    def visitFocusedLinearDataModifyingStatementBody(self, ctx:GQLParser.FocusedLinearDataModifyingStatementBodyContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#focusedNestedDataModifyingProcedureSpecification.
    def visitFocusedNestedDataModifyingProcedureSpecification(self, ctx:GQLParser.FocusedNestedDataModifyingProcedureSpecificationContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#ambientLinearDataModifyingStatement.
    def visitAmbientLinearDataModifyingStatement(self, ctx:GQLParser.AmbientLinearDataModifyingStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#ambientLinearDataModifyingStatementBody.
    def visitAmbientLinearDataModifyingStatementBody(self, ctx:GQLParser.AmbientLinearDataModifyingStatementBodyContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#simpleLinearDataAccessingStatement.
    def visitSimpleLinearDataAccessingStatement(self, ctx:GQLParser.SimpleLinearDataAccessingStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitPrimitiveDataModifyingStatement(self, ctx:GQLParser.PrimitiveDataModifyingStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitCallDataModifyingProcedureStatement(self, ctx:GQLParser.CallDataModifyingProcedureStatementContext):
        return self.visitChildren(ctx)
    ...
    def visitFocusedLinearQueryStatementPart(self, ctx:GQLParser.FocusedLinearQueryStatementPartContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#focusedLinearQueryAndPrimitiveResultStatementPart.
    def visitFocusedLinearQueryAndPrimitiveResultStatementPart(self, ctx:GQLParser.FocusedLinearQueryAndPrimitiveResultStatementPartContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#focusedPrimitiveResultStatement.
    def visitFocusedPrimitiveResultStatement(self, ctx:GQLParser.FocusedPrimitiveResultStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#focusedNestedQuerySpecification.
    def visitFocusedNestedQuerySpecification(self, ctx:GQLParser.FocusedNestedQuerySpecificationContext):
        return self.visitChildren(ctx)
    ...
    def visitLabelAndPropertySetSpecification(self, ctx:GQLParser.LabelAndPropertySetSpecificationContext):
        return self.visitChildren(ctx)
    ...
    def visitPpParenthesizedPathPatternExpression(self, ctx:GQLParser.PpParenthesizedPathPatternExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#ppSimplifiedPathPatternExpression.
    def visitPpSimplifiedPathPatternExpression(self, ctx:GQLParser.PpSimplifiedPathPatternExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitParenthesizedPathPatternExpression(self, ctx:GQLParser.ParenthesizedPathPatternExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitParenthesizedPathPatternWhereClause(self, ctx:GQLParser.ParenthesizedPathPatternWhereClauseContext):
        return self.visitChildren(ctx)
    ...
    def visitSimplifiedPathPatternExpression(self, ctx:GQLParser.SimplifiedPathPatternExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitSimplifiedDefaultingUndirected(self, ctx:GQLParser.SimplifiedDefaultingUndirectedContext):
        return self.visitChildren(ctx)
    ...
    def visitSimplifiedDefaultingLeftOrUndirected(self, ctx:GQLParser.SimplifiedDefaultingLeftOrUndirectedContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#simplifiedDefaultingUndirectedOrRight.
    def visitSimplifiedDefaultingUndirectedOrRight(self, ctx:GQLParser.SimplifiedDefaultingUndirectedOrRightContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#simplifiedDefaultingLeftOrRight.
    def visitSimplifiedDefaultingLeftOrRight(self, ctx:GQLParser.SimplifiedDefaultingLeftOrRightContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#simplifiedDefaultingAnyDirection.
    def visitSimplifiedDefaultingAnyDirection(self, ctx:GQLParser.SimplifiedDefaultingAnyDirectionContext):
        return self.visitChildren(ctx)
    ...
    def visitSimplifiedMultisetAlternation(self, ctx:GQLParser.SimplifiedMultisetAlternationContext):
        return self.visitChildren(ctx)
    ...
    def visitSimplifiedOverrideLeftOrUndirected(self, ctx:GQLParser.SimplifiedOverrideLeftOrUndirectedContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#simplifiedOverrideUndirectedOrRight.
    def visitSimplifiedOverrideUndirectedOrRight(self, ctx:GQLParser.SimplifiedOverrideUndirectedOrRightContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#simplifiedOverrideLeftOrRight.
    def visitSimplifiedOverrideLeftOrRight(self, ctx:GQLParser.SimplifiedOverrideLeftOrRightContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#simplifiedOverrideAnyDirection.
    def visitSimplifiedOverrideAnyDirection(self, ctx:GQLParser.SimplifiedOverrideAnyDirectionContext):
        return self.visitChildren(ctx)
    ...
    def visitAbsoluteCatalogSchemaReference(self, ctx:GQLParser.AbsoluteCatalogSchemaReferenceContext):
        return self.visitChildren(ctx)
    ...
    def visitRelativeCatalogSchemaReference(self, ctx:GQLParser.RelativeCatalogSchemaReferenceContext):
        return self.visitChildren(ctx)
    ...
    def visitCatalogGraphTypeParentAndName(self, ctx:GQLParser.CatalogGraphTypeParentAndNameContext):
        return self.visitChildren(ctx)
    ...
    def visitCatalogProcedureParentAndName(self, ctx:GQLParser.CatalogProcedureParentAndNameContext):
        return self.visitChildren(ctx)
    ...
    def visitReferenceParameterSpecification(self, ctx:GQLParser.ReferenceParameterSpecificationContext):
        return self.visitChildren(ctx)
    ...
    def visitDynamicPropertyValueTypeLabel(self, ctx:GQLParser.DynamicPropertyValueTypeLabelContext):
        return self.visitChildren(ctx)
    ...
    def visitUnsignedBinaryExactNumericType(self, ctx:GQLParser.UnsignedBinaryExactNumericTypeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#verboseBinaryExactNumericType.
    def visitVerboseBinaryExactNumericType(self, ctx:GQLParser.VerboseBinaryExactNumericTypeContext):
        return self.visitChildren(ctx)
    ...
    def visitClosedGraphReferenceValueType(self, ctx:GQLParser.ClosedGraphReferenceValueTypeContext):
        return self.visitChildren(ctx)
    ...
    def visitBindingTableReferenceValueType(self, ctx:GQLParser.BindingTableReferenceValueTypeContext):
        return self.visitChildren(ctx)
    ...
    def visitCharacterOrByteStringFunction(self, ctx:GQLParser.CharacterOrByteStringFunctionContext):
        return self.visitChildren(ctx)
    ...
    def visitTrimSingleCharacterOrByteString(self, ctx:GQLParser.TrimSingleCharacterOrByteStringContext):
        return self.visitChildren(ctx)
    ...
    def visitTrimMultiCharacterCharacterString(self, ctx:GQLParser.TrimMultiCharacterCharacterStringContext):
        return self.visitChildren(ctx)
    ...
    def visitNonParenthesizedValueExpressionPrimary(self, ctx:GQLParser.NonParenthesizedValueExpressionPrimaryContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#nonParenthesizedValueExpressionPrimarySpecialCase.
    def visitNonParenthesizedValueExpressionPrimarySpecialCase(self, ctx:GQLParser.NonParenthesizedValueExpressionPrimarySpecialCaseContext):
        return self.visitChildren(ctx)
    ...
    def visitNonNegativeIntegerSpecification(self, ctx:GQLParser.NonNegativeIntegerSpecificationContext):
        return self.visitChildren(ctx)
    ...
    def visitDynamicParameterSpecification(self, ctx:GQLParser.DynamicParameterSpecificationContext):
        return self.visitChildren(ctx)
    ...
    def visitPathValueConstructorByEnumeration(self, ctx:GQLParser.PathValueConstructorByEnumerationContext):
        return self.visitChildren(ctx)
    ...
    def visitListValueConstructorByEnumeration(self, ctx:GQLParser.ListValueConstructorByEnumerationContext):
        return self.visitChildren(ctx)
    ...
    def visitCardinalityExpressionArgument(self, ctx:GQLParser.CardinalityExpressionArgumentContext):
        return self.visitChildren(ctx)
    ...
    def visitNumericValueExpressionDividend(self, ctx:GQLParser.NumericValueExpressionDividendContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GQLParser#numericValueExpressionDivisor.
    def visitNumericValueExpressionDivisor(self, ctx:GQLParser.NumericValueExpressionDivisorContext):
        return self.visitChildren(ctx)
    ...
    def visitNumericValueExpressionExponent(self, ctx:GQLParser.NumericValueExpressionExponentContext):
        return self.visitChildren(ctx)
    ...
    def visitCharacterStringValueExpression(self, ctx:GQLParser.CharacterStringValueExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitTrimCharacterOrByteStringSource(self, ctx:GQLParser.TrimCharacterOrByteStringSourceContext):
        return self.visitChildren(ctx)
    ...
    def visitDatetimeSubtractionParameters(self, ctx:GQLParser.DatetimeSubtractionParametersContext):
        return self.visitChildren(ctx)
