...
def main():
    try:
        ...
        - schema_file (Path): The path of schema file (e.g, "examples/generated_schemas/banking_financial.json")
        - llm_client (LlmClient): The language model client used for schema generation (e.g, "qwen3-coder-plus-2025-07-22").
        """
